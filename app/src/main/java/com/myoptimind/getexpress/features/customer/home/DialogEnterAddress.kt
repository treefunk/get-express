...
import com.myoptimind.getexpress.features.shared.toReadableDateTime
...
@AndroidEntryPoint
class DialogEnterAddress: BaseDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(): DialogEnterAddress {
            val args = Bundle()

            val fragment = DialogEnterAddress ()
    ...
    private fun initClickListeners() {
        ib_close.setOnClickListener {
            this@DialogEnterAddress.dismiss()
        }
